...
def apply_llrq_drive_to_rates(kf_base: np.ndarray, kr_base: np.ndarray, 
                             B: np.ndarray, K_red: np.ndarray, 
                             u_red: np.ndarray) -> Tuple[np.ndarray, np.ndarray]:
...
def compute_equilibrium_shift(kf_base: np.ndarray, kr_base: np.ndarray,
                             kf_new: np.ndarray, kr_new: np.ndarray) -> np.ndarray:
...
def validate_llrq_control_mapping(B: np.ndarray, K_red: np.ndarray, 
                                 kf_base: np.ndarray, kr_base: np.ndarray,
                                 u_red: np.ndarray) -> dict:
...
def symmetric_rate_scaling(kf_base: np.ndarray, kr_base: np.ndarray,
                          speed_factor: float) -> Tuple[np.ndarray, np.ndarray]:
...
def combined_llrq_and_speed_control(kf_base: np.ndarray, kr_base: np.ndarray,
                                   B: np.ndarray, K_red: np.ndarray,
                                   u_red: np.ndarray, 
                                   speed_factors: np.ndarray = None) -> Tuple[np.ndarray, np.ndarray]:
